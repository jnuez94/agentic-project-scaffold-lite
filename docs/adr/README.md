...
Decisions that shape the coordination layer and are not derivable from the
code or the contracts. One decision per record; records are immutable once
accepted and superseded by new records rather than edited.
...
| [0004](0004-schema-v2-ledger-change-log-migration.md) | Schema version 2: append-only ledger, change log, and migration | Accepted |
